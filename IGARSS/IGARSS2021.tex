...
%The parameter $t$ in diffusion distance informs how long the diffusion process runs.  In this paper, we set $t$ to be 30; diffusion learning is relatively robust to choice of $t$ \cite{Murphy2019_Unsupervised}. 
...
%and show the superiority of the principled approach through theoretical results and numerical experiments. 
